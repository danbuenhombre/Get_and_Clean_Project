...
The tidy data set includes only the mean and standard deviation (std) variables, all of which are numeric variables.  The following variable description was taken directly from the features_info.txt file included in the source data.
